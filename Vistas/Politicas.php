        ...
        <nav class="menu">
            <ul>
                <li><a href="Panel_proveedor.php" style="font-weight: bold;">Inicio</a></li>
                  <li><a href="pdf_politicas.php" style="font-weight: bold;">Subir politica</a></li>
...
<center>
      ...
      <?php
        ...
        require("../Controlador/Conexion.php");
        $sql=("SELECT * FROM Politicas WHERE laboratorio='$NombreR'");
...
echo "<td><a href='archivo_politicas.php?id=$arreglo[0]'>Ver Politica</a></td>";
