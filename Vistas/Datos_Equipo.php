  ...
  <input type="hidden" name="total" value="<?php /*echo $_GET["total"] */ ?>">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" name="equipo" class="form-control" id="equipo" value="<?php echo isset($_POST["equipoCGnombre"]) ? $_POST["equipoCGnombre"] : ''; ?>" readonly="">
          </div>
          <div class="form-group col-md-6">
            <label for="inputEmail3" style="color:#808080">
              <h6>Marca</h6>
            </label>
            <input type="text" name="marca" class="form-control" id="marca" value="<?php echo isset($_POST["marca"]) ? $_POST["marca"] : ''; ?>" placeholder="" minlength="3" maxlength="30" required>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" name="modelo" class="form-control" id="modelo" value="<?php echo isset($_POST["modelo"]) ? $_POST["modelo"] : ''; ?>" placeholder="" minlength="1" maxlength="20" required>
          </div>
          <div class="form-group col-md-6">
            <label for="inputEmail3" style="color:#808080">
              <h6>Serie</h6>
            </label>
            <input type="text" name="serie" class="form-control" id="serie" value="<?php echo isset($_POST["serie"]) ? $_POST["serie"] : ''; ?>" placeholder="" minlength="1" maxlength="20" required>
          </div>
        </div>
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" name="identificacion" class="form-control" id="identificacion" value="<?php echo isset($_POST["identificacion"]) ? $_POST["identificacion"] : ''; ?>" placeholder="" minlength="1" max="30" required>
          </div>
          <?php
          ...
          <div class="form-group col-md-6">
            <label for="inputEmail3" style="color:#808080">
              <h6>Elige el proveedor adecuado</h6>
            </label>
