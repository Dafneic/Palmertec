    ...
    <header style="background-color:#f1eeee ">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="Registro_tipo_servicios.php" style="font-weight: bold;">Registrar Servicio</a></li>
...
echo "<td><a href='modificar_servicio.php?id=$arreglo[0]'><img src='../img/modificar.png' width='60' class='img-rounded'></td>";
echo "<td><a href='Tipos_servicio.php?id=$arreglo[0]&idborrar=2'><img src='../img/borrar_usuario.png' width='60' class='img-rounded'/></a></td>";
        ...
        echo "</table>";
          ...
          if(@$idborrar==2){
            ...
            $sqlborrar="DELETE FROM servicio WHERE id_servicio=$id";
            $resborrar=mysqli_query($mysqli,$sqlborrar);
            echo '<script>alert("Palmertec a eliminado al el servicio")</script> ';
            echo "<script>location.href='Tipos_Servicio.php'</script>";
          }
