...
<div class="container">
    <div class="row text-center pt-4 pb-6">
        <div class="col-12">
            <h3 class="title">¿Que atención necesita?</h3><br>
   
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 col-12 text-center">
            <a class="undecorated-text" href="Servicio.php?tipo=normal">
                <div class="grow">
                ...
                <div class="col-md-6 col-12 text-center">
            <a class="undecorated-text" href="Servicio.php?tipo=urgente">
                <div class="grow">
                    <div class=""><img src="images/servicio.jpg" height="130" width="130"></div>
                    <h4 class="title">Urgente</h4><br><br><br>
                </div>
            </a>
...
<div class="pull-right"><input class="btn btn-secondary" type="button" value="Atrás" onClick="history.go(-1);"></div>
    ...
    <br><br><footer class="border-top footer text-muted border-top-color" style="background-color: #ffffff
">
