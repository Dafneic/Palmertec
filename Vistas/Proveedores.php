...
<body>
 ...
 <li><a href="Proveedores_sin_acreditacion.php" style="font-weight: bold;">Proveedores sin acreditación</a></li>
                 <li><a href="Proveedores_con_acreditacion.php" style="font-weight: bold;">Proveedores con acreditación</a></li>
...
<center>
<h4>Buscar Proveedor <input type="text" class="" name="buscador" id="buscador" value="" ></h4>
...
echo "<td><a href='registro_areas_laboratorio.php?id=$arreglo[0]'>Agregar calibraciones</a></td>"; 
echo "<td><a href='registro_areas_laboratorio_2.php?id=$arreglo[0]'>Agregar servicios</a></td>";           
