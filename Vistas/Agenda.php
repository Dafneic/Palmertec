        ...
        <nav class="menu">
            <ul>
                <li><a href="Panel_Administrador.php" style="font-weight: bold;">Inicio</a></li> 
                          ...
                          <li><a href="servicios_realizados.php" style="font-weight: bold;">Servicios realizados</a></li> 
...
<center>
      ...
      <?php
        ...
        require("../Controlador/Conexion.php");
        $sql=("SELECT * FROM pedidos where proveedor='$NombreR' and pago='realizado'");
...
echo "<td><a href='../Controlador/servicios_realizados.php?id=$arreglo[0]&idborrar=2'>servicio realizado</td>";
