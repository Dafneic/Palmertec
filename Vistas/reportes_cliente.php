...
$sql = "SELECT COUNT(*) FROM reportes_aceptados where nombre_razon_social= '$NombreR'";
   $ressql=mysqli_query($mysqli,$sql);
        while ($row=mysqli_fetch_row ($ressql)){
...
<center>
      ...
      <?php
        ...
        require("../Controlador/Conexion.php");
        $sql=("SELECT * FROM reportes_aceptados WHERE nombre_razon_social='$NombreR'");
...
echo "<td><a href='archivo_cliente.php?id=$arreglo[0]'>Ver archivo</a></td>";
