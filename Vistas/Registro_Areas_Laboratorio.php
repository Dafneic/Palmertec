...
<body>
   <header style="background-color:#f1eeee ">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="Areas_Laboratorio.php" style="font-weight: bold;">Cotizaciónes</a></li>
    ...
    <form name="MyForm" method="post" class="bg-white  shadow p-5 rounded-lg" action="../Controlador/Registro_Area_Laboratorio.php">
 ...
 <label>Laboratorio</label>
    ...
    <label for="name1">Magnitud</label>
  ...
  <div class="form-group">
    <label for="name1">Instrumento</label>
    ...
    <option value="1000"> $1000 </option>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" name="Exactitud" class="form-control" id="Exactitud" placeholder="" required pattern="[0-9]{1,10}" onkeypress="return permite(event, 'num')" >
            </div>
            <div class="form-group col-md-4">
         ...
         <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" name="precio" class="form-control" id="precio" placeholder="" pattern="[0-9]{1,10}" required
