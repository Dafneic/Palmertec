    ...
    <header style="background-color:#f1eeee ">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="Reportes.php" style="font-weight: bold;">Reportes</a></li>
...
<center>
     <div class="form-row">
         ...
         <?php
$id=$_GET['id'];
            echo"     <a href='../Controlador/Pago_aceptado.php?id=$id'><button type='button' class='btn btn-success btn-lg btn-block' href='#'
                    >Aceptar pago</button></a>";
  ...
  <?php
        ...
        $db=new Conect_MySql();
            $sql = "select*from pedidos where id_pedido=".$_GET['id'];
