        ...
        <nav class="menu">
            <ul>
                <li><a href="Panel_proveedor.php" style="font-weight: bold;">Inicio</a></li>
                  <li><a href="lista.php" style="font-weight: bold;">reportes</a></li>
...
<center>
      ...
      <?php
        ...
        require("../Controlador/Conexion.php");
        $sql=("SELECT * FROM reportes_rechazados WHERE laboratorio='$NombreR'");
...
echo "<td><a href='archivo_rechazado_p.php?id=$arreglo[0]'>Ver archivo</a></td>";
