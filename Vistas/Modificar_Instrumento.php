...
<body>
    ...
    <?php
        ...
        $sql="SELECT * FROM subservicios WHERE id=$id";
    ...
    <form method="post" class="bg-white  shadow p-5 rounded-lg" action="../Controlador/Modificar_instrumento.php">

        <img src="../img/palmertec.png" class="img-fluid mx-auto d-block pb-5" alt="Palmertec">
        <h4 class="pb-3" style="color:#0c62bf">Instrumentos</h4>
 ...
 <div class="form-group col-md-6">
                                   <select name="Servicio" id="Servicio" class="select-css" required>
                    <option value="0"> Seleccione una magnitud</option>
