    ...
    <header style="background-color:#f1eeee ">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="Registro_Instrumento.php" style="font-weight: bold;">Registrar Instrumento</a></li>
...
echo "<td><a href='modificar_instrumento.php?id=$arreglo[0]'><img src='../img/modificar.png' width='60' class='img-rounded'></td>";
echo "<td><a href='instrumentos.php?id=$arreglo[0]&idborrar=2'><img src='../img/borrar_usuario.png' width='60' class='img-rounded'/></a></td>";
        ...
        echo "</table>";
          ...
          if(@$idborrar==2){
            ...
            $sqlborrar="DELETE FROM subservicios WHERE id=$id";
            $resborrar=mysqli_query($mysqli,$sqlborrar);
            echo '<script>alert("Palmertec a eliminado el instrumento")</script> ';
            echo "<script>location.href='instrumentos.php'</script>";
          }
