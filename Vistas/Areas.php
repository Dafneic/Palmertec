    ...
    <header style="background-color:#f1eeee ">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="Registro_Area.php" style="font-weight: bold;">Registrar Área</a></li>
...
echo "<td><a href='Modificar_Area.php?id=$arreglo[0]'><img src='../img/modificar.png' width='60' class='img-rounded'></td>";
echo "<td><a href='Areas.php?id=$arreglo[0]&idborrar=2'><img src='../img/borrar_usuario.png' width='60' class='img-rounded'/></a></td>";
        ...
        echo "</table>";
          ...
          if(@$idborrar==2){
            ...
            $sqlborrar="DELETE FROM area WHERE id_arear=$id";
            $resborrar=mysqli_query($mysqli,$sqlborrar);
            echo '<script>alert("Palmertec a eliminado la área")</script> ';
            echo "<script>location.href='Areas.php'</script>";
          }
