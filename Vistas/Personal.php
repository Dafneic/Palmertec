    ...
    <header style="background-color:#f1eeee ">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="personald.php" style="font-weight: bold;">Personal disponible</a></li>
...
<div id="home-box">
<div class="content">
  <MARQUEE BGCOLOR=white style="color:blue" VSPACE=20> Seleccione una magnitud
</MARQUEE>
 <?php 
...
<center>
      ...
      <?php
        ...
        require("../Controlador/Conexion.php");
        $sql=("SELECT * FROM cotizaciones where laboratorio='$NombreR'");
...
echo "<td><a href='Registro_personal_disponible.php?id=$arreglo[0]&magnitud=$arreglo[4]'>Registrar</a></td>";
        ...
        echo "</table>";
          ...
          if(@$idborrar==2){
            ...
            $sqlborrar="DELETE FROM disponibilidad WHERE Id_disponibilidad=$id";
            $resborrar=mysqli_query($mysqli,$sqlborrar);
            echo '<script>alert("Palmertec a eliminado su disponibilidad")</script> ';
            echo "<script>location.href='disponibilidad.php'</script>";
          }
