...
<h4>Buscar Laboratorio <input type="text" class="" name="buscador" id="buscador" value="" ></h4>
      ...
      <?php
        ...
        $sql=("SELECT * FROM cotizaciones_servicios");
...
$idCot=$arreglo[0];
echo "<td><a href='Areas_Laboratorio_2.php?id=$arreglo[0]&idborrar=2'><img src='../img/borrar_area.png' width='60' class='img-rounded'/></a></td>";
echo "<td><button type='button' class='btn btn-primary btn-lg' data-toggle='modal' data-target='#PRUEBA-$idCot'>Etapas</button>";
include('PRUEBITA_2.php');
echo "</td>";
        ...
        // echo "</table>";
          ...
          if(@$idborrar==2){
            ...
            $sqlborrar="DELETE FROM cotizaciones_servicios WHERE id_cotizacion=$id";
            $resborrar=mysqli_query($mysqli,$sqlborrar);
            echo '<script>alert("Palmertec a eliminado la cotización")</script> ';
            echo "<script>location.href='Areas_Laboratorio_2.php'</script>";
          }
