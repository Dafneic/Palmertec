  ...
  echo "<tr>";
      ...
      <?php 
         while($arreglo=mysqli_fetch_array($query)){
             if ($arreglo[15]== "pendiente") {
     ?><CENTER>
<MARQUEE WIDTH=70% BGCOLOR=white>
<FONT FACE=arial COLOR=red SIZE=5>
Un pago fue realizado por transferencia verifique los datos
</FONT>
</MARQUEE>
</CENTER>
...
echo "<td><a style='color:blue' href='archivo_pedido.php?id=$arreglo[0]'>Ver movimientos</a></td>";
        ...
        echo "</table>";
          ...
          if(@$idborrar==2){
            ...
            echo '<script>alert("Palmertec a eliminado al cliente")</script> ';
