...
<body>
    ...
    <form method="post" class="bg-white  shadow p-5 rounded-lg" action="../Controlador/Registro_Tipo_Servicio.php">

        <img src="../img/palmertec.png" class="img-fluid mx-auto d-block pb-5" alt="Palmertec">
        <center><h4 class="pb-3" style="color:#0c62bf">Registro de servicios</h4>
