...
$sql = "SELECT COUNT(*)  FROM tbl_documentos";
   $ressql=mysqli_query($mysqli,$sql);
        while ($row=mysqli_fetch_row ($ressql)){
...
<div class="row">
    ...
    <br>
            ...
            <div class="form-group col-md-4">
                 <a href="Proveedores.php"><button type="button" class="btn btn-primary btn-lg btn-block" href="#"
                    >Proveedores</button></a>
            </div>
            <div class="form-group col-md-4">
     <a href="Areas_Laboratorio.php"><button type="button" class="btn btn-primary btn-lg btn-block" href="#">Servicios</button></a>

                
            </div>
             <div class="form-group col-md-4">
      
                   <a style="color: white" href="pedidos_admin.php"><button type="button" class="btn btn-primary btn-lg btn-block" href="#"> Agenda de servicios <a style="color:yellow" ><?php if ($Total == 0) { }else{ echo $Total; }  ?> </a></button></a>
         ...
         <div class="form-row">
              <div class="form-group col-md-4">
                 ...
                 <a href="Clientes.php"><button type="button" class="btn btn-primary btn-lg btn-block" href="#"
                    >Clientes</button></a>
            ...
            <div class="form-group col-md-4">
                   ...
                   <a href="Reportes.php" style="color: white"><button type="button" class="btn btn-primary btn-lg btn-block" href="#"> Reportes pdf <a style="color:yellow" ><?php if ($Totala == 0) { }else{ echo $Totala; }  ?> </a></button></a>
              
            </div>
             <div class="form-group col-md-4">
    
            <a href="servicios_realizados_a.php"><button type="button" class="btn btn-primary btn-lg btn-block" href="#"
                    >Servicios realizados</button></a>
            </div>
