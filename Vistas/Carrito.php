     ...
     <table class='table table-striped table-sm table-responsive-sm'>
        <thead style='color: blue' background='gray' align="center">
            ...
            <tr>
                ...
                <td><?php echo $value['item_alcance'];?></td>
                <td><?php echo $value['item_puntosc'];?></td>
                ...
                <td>$<?php echo number_format($value['item_cantidad'] * $value['item_precio'],2);?></td>
                       <td><a class="btn btn-danger" href="carrito.php?action=delete&identificacion=<?php echo $value['item_identificacion'];?>">Quitar del carrito</a></td>
            </tr>
           <?php
