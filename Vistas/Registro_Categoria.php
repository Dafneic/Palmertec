...
<body>
    ...
    <form method="post" class="bg-white  shadow p-5 rounded-lg" action="../Controlador/Registro_Categoria.php">

        <img src="../img/palmertec.png" class="img-fluid mx-auto d-block pb-5" alt="Palmertec">
        <center><h4 class="pb-3" style="color:#0c62bf">Registro de categorias</h4>

       <div class="form-group">
          <div class="text-center">
                <label for="inputEmail3" style="color:#808080"><h6>Nombre</h6></label>
                <input type="text" name="Nombre" class="form-control" id="Nombre" placeholder="" minlength="3" required>
            </div>
    </div>
    ...
    <div class="pull-right"><input class="btn btn-secondary" type="button" value="Atrás" onClick="history.go(-1);"></div><br></center>
