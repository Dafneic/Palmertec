...
<body>
    ...
    <form method="post" class="bg-white  shadow p-5 rounded-lg" action="../Controlador/Registro_Instrumento.php">

        <img src="../img/palmertec.png" class="img-fluid mx-auto d-block pb-5" alt="Palmertec">
        <center><h4 class="pb-3" style="color:#0c62bf">Registro de instrumento</h4>
 <div class="form-group">
         <div class="text-center">
  <label class="control-label">Tipo de magnitud</label>
  <br>
