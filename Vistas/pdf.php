...
<?php 
$id_p=$_SESSION['id_proveedor'];

        require("../Controlador/Conexion.php");

        $sql="SELECT * FROM proveedor WHERE id_proveedor=$id_p";
...
if (isset($_POST['subir'])) {
    ...
    if ($nombre != "") {
        if (copy($ruta, $destino)) {
            ...
            $db=new Conect_MySql();
            $sql = "INSERT INTO tbl_documentos(laboratorio,titulo,descripcion,nombre_razon_social,tamanio,tipo,nombre_archivo) VALUES('$laboratorio','$titulo','$descri','$cliente','$tamanio','$tipo','$nombre')";
...
$id=$_SESSION['id_proveedor'];
     ...
     ?>
            ...
            <div class="form-group col-md-12">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="text" name="titulo" placeholder="ingrese el titulo"></td>
                    </tr>
                    <tr>
                        <td><label>Descripcion</label></td>
                        <td><textarea class="form-control" name="descripcion" placeholder="ingrese una descripción"></textarea></td>
                    </tr>
                      <tr>
                        <td><label>Nombre o razón social</label></td>
                                                     <td>     <select name="cliente" id="cliente" class="select-css" required>
      ...
      try {
       ...
       $sql=("SELECT * FROM servicios_realizados where proveedor='$Nom'");
