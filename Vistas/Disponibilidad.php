    ...
    <header style="background-color:#f1eeee ">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="Registro_disponibilidad.php" style="font-weight: bold;">Registrar disponibilidad</a></li>
...
<center>
      ...
      <?php
        ...
        require("../Controlador/Conexion.php");
        $sql=("SELECT * FROM disponibilidad where empresa='$NombreR'");
...
echo "<td><a href='disponibilidad.php?id=$arreglo[0]&idborrar=2'><img src='../img/borrar_usuario.png' width='60' class='img-rounded'/></a></td>";
