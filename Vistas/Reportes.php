        ...
        <nav class="menu">
            <ul>
                <li><a href="Panel_Administrador.php" style="font-weight: bold;">Inicio</a></li>
                 ...
                 <li><a href="Reportes_Aceptados.php" style="font-weight: bold;">Reportes aceptados</a></li>
           
                 <li><a href="Reportes_Rechazados.php" style="font-weight: bold;">Reportes rechazados</a></li>
...
echo "<td><a style='color:blue' href='archivo_admin.php?id=$arreglo[0]'>Ver archivo</a>
<br>
<a style='color: green' href='../Controlador/Reportes_Aceptados.php?id=$arreglo[0]&idborrar=2&laboratorio=$arreglo[1]&titulo=$arreglo[2]&descripcion=$arreglo[3]&razon=$arreglo[4]&tamaño=$arreglo[5]&tipo=$arreglo[6]&nombre=$arreglo[7]'>Aceptar reporte</a>
<br>
<a style='color: red' href='../Controlador/Reportes_Rechazados.php?id=$arreglo[0]&idborrar=2&laboratorio=$arreglo[1]&titulo=$arreglo[2]&descripcion=$arreglo[3]&razon=$arreglo[4]&tamaño=$arreglo[5]&tipo=$arreglo[6]&nombre=$arreglo[7]'>Rechazar reporte</a></td>";
