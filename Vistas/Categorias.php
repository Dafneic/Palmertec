        ...
        <nav class="menu">
            <ul>
                ...
                <li ><a href="Panel_Administrador.php" style="font-weight: bold;">Inicio</a></li>
                            <li>
                                 <li ><a href="Registro_Categoria.php" style="font-weight: bold;">Registrar Categoría</a></li>
                            <li>
...
echo "<td><a href='modificar_categoria.php?id=$arreglo[0]'><img src='../img/modificar.png' width='60' class='img-rounded'></td>";
echo "<td><a href='categoria.php?id=$arreglo[0]&idborrar=2'><img src='../img/borrar_usuario.png' width='60' class='img-rounded'/></a></td>";
        ...
        echo "</table>";
          ...
          if(@$idborrar==2){
            ...
            $sqlborrar="DELETE FROM categorias WHERE id_categoria=$id";
