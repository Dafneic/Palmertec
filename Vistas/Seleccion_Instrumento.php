...
<div class="container">
    ...
    <form method="post" class="bg-white  shadow p-5 rounded-lg" action="Seleccion_Proveedor.php">

         <div class=""><center>
                    <div class=""><img src="images/servicio.jpg" height="130" width="130"></div>
                    <h4 class="title">Servicio</h4>
                </div>
          <center><h3>Selecciona el servicio que desees</h3></center>  
  ...
  <br>
                                                 <select name="Instrumento" id="Instrumento" class="select-css" required>
      ...
      try {
       ...
       $sql=("SELECT * FROM subservicios where servicio_id='$id'");
